    ...
    <div className="px-4 py-12 mx-auto space-y-24 max-w-7xl">
      {playersByPosition.map(({ position, players }) => (
        <section key={position}>
          <h2 className="relative mb-10 text-3xl font-extrabold tracking-tight text-primary">
            ...
            {players.map((player) => (
              ...
              >
                ...
                <div className="p-5 text-center">
                  <h3 className="text-xl font-semibold text-gray-800 transition-colors duration-200 group-hover:text-primary">
                    {player.name}
                  </h3>
